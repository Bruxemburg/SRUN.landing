...
<template>
  <div class="srun-management flex flex-col py-7.5em justify-center items-center relative bg-gray-50">
    <div class="first absolute top-0 left-0 h-screen" />
    ...
    <div class="second absolute top-100vh left-0 h-screen" />
  </div>
  <div class="h-100vh" />
